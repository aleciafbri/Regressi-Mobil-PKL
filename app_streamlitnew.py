    ...
    <div class="lv-brand">
        <div class="lv-brand-logo">
            <svg width="34" height="34" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5 11l1.5-4.5A2 2 0 0 1 8.4 5h7.2a2 2 0 0 1 1.9 1.5L19 11M5 11h14M5 11a2 2 0 0 0-2 2v3a1 1 0 0 0 1 1h1m15-4a2 2 0 0 1 2 2v3a1 1 0 0 1-1 1h-1M5 17v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1m8 0v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1v-1" stroke="white" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/>
                <circle cx="8" cy="14.5" r="1" fill="white"/>
                <circle cx="16" cy="14.5" r="1" fill="white"/>
            </svg>
        </div>
        <div class="lv-brand-name">CarPrice AI</div>
        <div class="lv-brand-tag">ML PREDICTION ENGINE</div>
    </div>
...
# ============================================================
tab_prediksi, tab_home, tab_analisis, tab_tentang = st.tabs([
    "Prediksi Harga",
    "Home",
    "Analisis Data",
    "👤 Tentang Saya",
